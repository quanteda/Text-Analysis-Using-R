...
# require phrase()
tokens("natural language processing with quanteda") |> 
    tokens_replace(pattern = phrase(c("natural language processing")), replacement = "NLP")

# replacement does not work without phrase()
tokens("natural language processing with quanteda") |> 
    tokens_replace(pattern = "natural language processing", replacement = "NLP")
```
:::
